...
def realizar_cadastro():
    ...
    while True:
        try:
            loguin_usuario = input("Digite seu novo login: ")
            senha_usuario = input("Digite sua nova senha (mínimo 6 caracteres): ")
            
            if len(loguin_usuario) < 1:
                ...
                print(f"Bem-vindo ao sistema, {loguin_usuario}!")
                return loguin_usuario # Retorna o nome para o sistema saber quem logou
        except ValueError:
